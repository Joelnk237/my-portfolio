...
export default function HeroSection() {
	return (
		<section className="relative min-h-scren items-center justify-center overflow-hidden h-[95vh]"> {/* relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 */}
			...
			<div className="relative z-10 flex-col items-center justify-center px-4">
